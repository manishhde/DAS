      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2 space-y-6">
            <h2 className="text-[#D4AF37] font-serif text-4xl md:text-5xl mb-4 text-left">
              The Studio
            </h2>
            ...
            <p className="text-gray-400 leading-relaxed text-lg">
              ...
              </span>, DAS STUDIO has been a trusted name in high-end photography for over a decade. We specialize in blending modern aesthetics with traditional emotions.
            </p>
